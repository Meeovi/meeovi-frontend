<template>
    <div>
        <section class="info3 cid-skeI6phSf7" id="info3-e">
        ...
        <div class="card col-12 col-lg-10">
            <div class="card-wrapper">
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong>Meeovi Fitness</strong></h4>
...
<section class="features3 cid-skeIblqPE5" id="features3-f">

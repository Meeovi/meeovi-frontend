<template>
    <div>
        <section data-bs-version="5.1" class="carousel slide cid-tAGT4WiXVu" data-interval="false"
            data-bs-interval="false" id="slider1-5v">



            <div class="full-screen">
                <div class="mbr-slider slide carousel" data-keyboard="false" data-bs-keyboard="false" data-ride="false"
                    data-bs-ride="false" data-interval="false" data-bs-interval="false" data-bs-pause="false"
                    data-pause="false">
                    <ol class="carousel-indicators">
                        <li data-app-prevent-settings="" data-target="#slider1-5v" data-bs-target="#slider1-5v"
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item slider-fullscreen-image active" data-bg-video-slide="false"
                            style="background-image: url(../../assets/images/mbr-1900x1425.jpg);">
                            <div class="container container-slide">
                                <div class="image_wrapper">
                                    <div class="mbr-overlay"></div><img src="../../assets/images/mbr-1900x1425.jpg"
                                        alt="" title="">
                                    <div class="carousel-caption justify-content-center">
                                        <div class="col-10 align-center">
                                            <h2 class="mbr-fonts-style display-1">Meeovi</h2>
                                            <p class="lead mbr-text mbr-fonts-style display-5">If you have products to
                                                sell, Meeovi is for you. With 85% of your comission from each sale going
                                                into your pocket. No Monthly or Upfront fees.&nbsp;<br></p>
                                            <div class="mbr-section-btn" buttons="0"> <a
                                                    class="btn btn-white-outline display-4" href="/sell/">Become a
                                                    Seller</a></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false"
                            ...
                            <div class="container container-slide">
                                <div class="image_wrapper">
                                    <div class="mbr-overlay"></div><img src="../../assets/images/background2.jpg" alt=""
                                        title="">
                                    <div class="carousel-caption justify-content-center">
                                        <div class="col-10 align-left">
                                            <h2 class="mbr-fonts-style display-1">The Products</h2>
                                            <p class="lead mbr-text mbr-fonts-style display-5">There are millions of
                                                unique products found on Meeovi. Digital, handmade, physical, services,
                                                and more. You are sure to find what you truely want.<br></p>
                                            <div class="mbr-section-btn" buttons="0"><a
                                                    class="btn btn-primary display-4"
                                                    href="/social/inspirationwalls">Inspiration Walls</a> <a
                                                    class="btn btn-white-outline display-4" href="/search/">Search the
                                                    Marketplace</a></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false"
                            ...
                            <div class="container container-slide">
                                <div class="image_wrapper">
                                    <div class="mbr-overlay"></div><img src="../../assets/images/background3.jpg" alt=""
                                        title="">
                                    <div class="carousel-caption justify-content-center">
                                        <div class="col-10 align-right">
                                            <h2 class="mbr-fonts-style display-1">The Engagements</h2>
                                            <p class="lead mbr-text mbr-fonts-style display-5">As a social marketplace,
                                                we pride ourselves on connecting customers with sellers. With sharing
                                                tools, product videos, chat system, messages, and activity feed.<br></p>
                                            <div class="mbr-section-btn" buttons="0"><a class="btn btn-info display-4"
                                                    href="/social/feed">Social Feed</a> <a
                                                    class="btn btn-white-outline display-4"
                                                    href="/social/spaces">Spaces</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        data-slide="prev" data-bs-slide="prev" href="#slider1-5v"><span aria-hidden="true"
                        ...
                        data-bs-slide="next" href="#slider1-5v"><span aria-hidden="true"
                            class="mbri-right mbr-iconfont"></span><span class="sr-only visually-hidden">Next</span></a>
                </div>
            </div>

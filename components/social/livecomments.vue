                  ...
                  <div class="col-12 col-md-6 col-lg-9">
                    <div class="description">
                      ...
                      <div class="user_desk mbr-fonts-style display-4">
                        <span>
                          <v-rating half-increments hover
                            :length="products?.items?.reviews?.items?.ratings_breakdown?.value" :size="32"
                            :model-value="products?.items?.reviews?.items?.ratings_breakdown?.name" color="warning"
                            active-color="warning" /></span>
                      </div>

                      <div class="user_desk mbr-fonts-style display-4">
                        <span>Was this comment helpful? <v-btn prepend-icon="fas fa-thumbs-up" variant="text">
                            ({{ products?.items?.reviews?.items?.average_rating }})</v-btn>
...
<script>
  import createcomment from '../../components/create/social/createcomment.vue'

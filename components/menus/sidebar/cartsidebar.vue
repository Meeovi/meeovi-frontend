        ...
        <SfSidebar v-e2e="'sidebar-cart'" :visible="isCartSidebarOpen" title="My Cart" class="sf-sidebar--right"
            ...
            <transition name="sf-fade" mode="out-in">
                    ...
                    <div class="collected-product-list">
                        <transition-group name="sf-fade" tag="div">
                            <SfCollectedProduct v-for="product in products" v-e2e="'collected-product'"
                                ...
                                :stock="99999" @click:remove="removeItem({ product: { id: product.id } })"
                                ...
                                <template #input>
                                    <div class="sf-collected-product__quantity-wrapper">
                                        <SfQuantitySelector :disabled="loading" :qty="cartGetters.getItemQty(product)"
                ...
                <div v-else key="empty-cart" class="empty-cart">
                    <div class="empty-cart__banner">
                        <SfImage alt="Empty bag" class="empty-cart__image"
            ...
            <template #content-bottom>
                <transition name="sf-fade">
                    <div v-if="totalItems">
                        <SfProperty name="Subtotal price"
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const updateQuantity = debounce(async ({
                product,
                quantity
            }) => {
                await updateItemQty({

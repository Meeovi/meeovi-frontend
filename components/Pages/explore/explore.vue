<template>
  <div>
      ...
      <div class="align-center container">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-6">
            <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1" style="color: white"><strong>{{ pages.name }}</strong>
            </h1>
            <p class="mbr-text mbr-fonts-style display-7" v-html="pages.content"></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <v-row class="pa-4">
      <v-col cols="3" v-for="product in products" :key="product">
...
const pages = await getItems({ collection: "pages", params: {filter: {name: {_eq: "Explore"}}}});
const products = await getItems({ collection: "products", params: { limit: 50 },});

/*  import pages from '../../apollo/Custom/Queries/explore'
  import products from '../../apollo/Custom/Queries/exploreProducts'

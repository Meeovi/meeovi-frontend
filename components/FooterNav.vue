    ...
    <v-footer border>
        <v-row justify="center" no-gutters>
            <v-col class="text-center mt-4" cols="3">
                ...
                <v-list-item title="Diversity & Inclusion" value="Diversity & Inclusion" href="/about/dei"></v-list-item>
            ...
            <v-col class="text-center mt-4" cols="3">
                ...
                <v-list-item class="fas fa-mobile" title="Get the App" value="Get the App" href="/applications"></v-list-item>
            </v-col>
        </v-row>
    </v-footer>
</template>

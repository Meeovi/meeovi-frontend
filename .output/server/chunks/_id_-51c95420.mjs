...
import { _ as _imports_0 } from './mbr-676x459-e8ec3c83.mjs';
import { _ as _imports_0$1, a as _imports_1 } from './product4-d899b70d.mjs';
import { _ as _imports_2 } from './product3-6b7493d9.mjs';
import { _ as _imports_0$2 } from './1-e41cf1d9.mjs';
import './server.mjs';
import './renderer.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_col, { cols: "3" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card card-category"${_scopeId2}><div class="img-wrap" style="${ssrRenderStyle({ "background": "#ffd7d7" })}"${_scopeId2}><img${ssrRenderAttr("src", _imports_0$2)}${_scopeId2}></div><div class="card-body"${_scopeId2}><h4 class="card-title"${_scopeId2}><a href="/product/video/"${_scopeId2}>Summer shirts</a></h4></div></div>`);
                } else {
                  return [
...
//# sourceMappingURL=_id_-51c95420.mjs.map

import { resolveComponent, mergeProps, withCtx, createVNode, createTextVNode, withModifiers, useSSRContext } from 'file://C:/Users/Basti/OneDrive/Documents/My%20Websites/Handmade%20Sites/Javascript-Projects/Nuxt-Projects/AlternateCMS-Framework/TheMeeoviCompany-Sites/meeovi-frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent } from 'file://C:/Users/Basti/OneDrive/Documents/My%20Websites/Handmade%20Sites/Javascript-Projects/Nuxt-Projects/AlternateCMS-Framework/TheMeeoviCompany-Sites/meeovi-frontend/node_modules/vue/server-renderer/index.mjs';
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          ...
                          _push5(ssrRenderComponent(_component_v_card_title, null, {
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<span class="text-h6"${_scopeId5}>Create new Address</span>`);
                              } else {
                                return [
                                  createVNode("span", { class: "text-h6" }, "Create new Address")
                                ];
                              }
                            }),
                            _: 1
                    ...
                    return [
                      createVNode("form", {
                        method: "post",
                        "onVOn:submit": withModifiers(($event) => _ctx.addAddress(), ["prevent"])
                      }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Admin/User/addAccount/add-address.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const addAddress = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { addAddress as default };
//# sourceMappingURL=add-address-e9801a6c.mjs.map

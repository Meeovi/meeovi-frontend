...
import { _ as _imports_0$1 } from "./07-37f81037.js";
import { _ as _imports_0$2 } from "./product2-b472875b.js";
import { _ as _imports_0$3, a as _imports_1, b as _imports_2, c as _imports_3 } from "./16-33a9678d.js";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_col, { cols: "3" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="card card-category"${_scopeId2}><div class="img-wrap" style="${ssrRenderStyle({ "background": "#ffd7d7" })}"${_scopeId2}><img${ssrRenderAttr("src", _imports_0)}${_scopeId2}></div><div class="card-body"${_scopeId2}><h4 class="card-title"${_scopeId2}><a href="/product/gallery/"${_scopeId2}>Summer shirts</a></h4></div></div>`);
                } else {
                  return [
...
//# sourceMappingURL=_id_-ab1ae418.js.map

...
import type { CustomerAddress } from '~/graphql/queries-mutations_subscriptions/types/MyAccount.type';
import type { OrderAddress } from '~/graphql/queries-mutations_subscriptions/types/Order.type';
import type { Country, Region } from '~/graphql/queries-mutations_subscriptions/types/Region.type';
import type { Store } from '~/graphql/queries-mutations_subscriptions/types/StoreInPickUp.type';
import { CheckoutAddress } from 'Route/Checkout/Checkout.type';
import { GQLCountryCodeEnum, type GQLCustomerAddressInput } from '~/types/Graphql.type';

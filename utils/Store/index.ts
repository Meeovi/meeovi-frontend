...
/**
 * Configure the store
 * @namespace ~/utils/Store/Index/configureStore
 */
...
/** @namespace ~/utils/Store/Index/noopReducer */
...
/** @namespace ~/utils/Store/Index/getStore */
export const getStore = (): typeof store => store;

/** @namespace ~/utils/Store/Index/getStoreState */
export const getStoreState = (): Partial<RootState> => store.getState() || {};

/** @namespace ~/utils/Store/Index/injectReducers */

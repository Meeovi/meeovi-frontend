 ...
 * @namespace ~/utils/~/graphql/queries-mutations_subscriptions/types/PrepareDocument/prepareFieldString */
...
/** @namespace ~/utils/~/graphql/queries-mutations_subscriptions/types/PrepareDocument/prepareRequest */
...
/** @namespace ~/utils/~/graphql/queries-mutations_subscriptions/types/PrepareDocument/prepareMutation */
export const prepareMutation = <T>(
    mutations: Mutation<string, T, boolean>[],
): QueryObject => prepareRequest(mutations, FieldType.MUTATION);

/** @namespace ~/utils/~/graphql/queries-mutations_subscriptions/types/PrepareDocument/prepareQuery */

    ...
    <header class="flex justify-center w-full py-2 px-4 lg:py-5 lg:px-6 bg-primary-700 border-b border-neutral-200">
        <div
            ...
            <a href="#" aria-label="SF Homepage"
                ...
                <img src="https://storage.googleapis.com/sfui_docs_artifacts_bucket_public/production/alokai-logo-white.svg"
                    alt="Sf Logo" class="w-[110px] md:h-6 md:w-[110px] lg:w-[10.5rem] lg:h-[1.75rem]" />
            </a>
            ...
            <form role="search" class="hidden md:flex flex-[100%] order-last lg:order-3 mt-2 lg:mt-0 pb-2 lg:pb-0"
                ...
                <SfInput type="search" class="[&::-webkit-search-cancel-button]:appearance-none" placeholder="Search"
                    wrapper-class="flex-1 h-10 pr-0 rounded-full" size="base" v-model="inputValue">
                    <template #suffix>

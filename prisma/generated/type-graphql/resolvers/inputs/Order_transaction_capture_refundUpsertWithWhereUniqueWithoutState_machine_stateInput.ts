...
@TypeGraphQL.InputType("Order_transaction_capture_refundUpsertWithWhereUniqueWithoutState_machine_stateInput", {})
export class Order_transaction_capture_refundUpsertWithWhereUniqueWithoutState_machine_stateInput {
  ...
  update!: Order_transaction_capture_refundUpdateWithoutState_machine_stateInput;

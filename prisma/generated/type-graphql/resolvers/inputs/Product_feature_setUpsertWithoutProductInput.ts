...
@TypeGraphQL.InputType("Product_feature_setUpsertWithoutProductInput", {})
export class Product_feature_setUpsertWithoutProductInput {
  @TypeGraphQL.Field(_type => Product_feature_setUpdateWithoutProductInput, {
    nullable: false
  })
  update!: Product_feature_setUpdateWithoutProductInput;

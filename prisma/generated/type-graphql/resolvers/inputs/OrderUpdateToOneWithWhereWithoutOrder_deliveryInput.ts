...
@TypeGraphQL.InputType("OrderUpdateToOneWithWhereWithoutOrder_deliveryInput", {})
export class OrderUpdateToOneWithWhereWithoutOrder_deliveryInput {
  ...
  data!: OrderUpdateWithoutOrder_deliveryInput;
}

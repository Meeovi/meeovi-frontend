...
@TypeGraphQL.InputType("Document_base_config_sales_channelUpsertWithWhereUniqueWithoutSales_channelInput", {})
export class Document_base_config_sales_channelUpsertWithWhereUniqueWithoutSales_channelInput {
  ...
  update!: Document_base_config_sales_channelUpdateWithoutSales_channelInput;

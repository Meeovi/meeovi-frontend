...
@TypeGraphQL.InputType("Number_rangeUpsertWithoutNumber_range_translationInput", {})
export class Number_rangeUpsertWithoutNumber_range_translationInput {
  @TypeGraphQL.Field(_type => Number_rangeUpdateWithoutNumber_range_translationInput, {
    nullable: false
  })
  update!: Number_rangeUpdateWithoutNumber_range_translationInput;

...
@TypeGraphQL.InputType("CategoryUpsertWithWhereUniqueWithoutProduct_streamInput", {})
export class CategoryUpsertWithWhereUniqueWithoutProduct_streamInput {
  ...
  update!: CategoryUpdateWithoutProduct_streamInput;

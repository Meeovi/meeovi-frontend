...
import { Cms_slotCreateNestedManyWithoutCms_blockInput } from "../inputs/Cms_slotCreateNestedManyWithoutCms_blockInput";
import { MediaCreateNestedOneWithoutCms_blockInput } from "../inputs/MediaCreateNestedOneWithoutCms_blockInput";

@TypeGraphQL.InputType("Cms_blockCreateWithoutCms_sectionInput", {})
export class Cms_blockCreateWithoutCms_sectionInput {
  ...
  @TypeGraphQL.Field(_type => Cms_slotCreateNestedManyWithoutCms_blockInput, {
    nullable: true
  })
  cms_slot?: Cms_slotCreateNestedManyWithoutCms_blockInput | undefined;
}

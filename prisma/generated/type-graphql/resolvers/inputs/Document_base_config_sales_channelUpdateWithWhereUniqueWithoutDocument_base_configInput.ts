...
@TypeGraphQL.InputType("Document_base_config_sales_channelUpdateWithWhereUniqueWithoutDocument_base_configInput", {})
export class Document_base_config_sales_channelUpdateWithWhereUniqueWithoutDocument_base_configInput {
  ...
  data!: Document_base_config_sales_channelUpdateWithoutDocument_base_configInput;
}

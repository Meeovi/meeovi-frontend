...
@TypeGraphQL.InputType("ProductCreateWithoutSwag_paypal_pos_sales_channel_run_logInput", {})
export class ProductCreateWithoutSwag_paypal_pos_sales_channel_run_logInput {

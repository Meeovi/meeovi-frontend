...
@TypeGraphQL.InputType("Dead_messageUpsertWithWhereUniqueWithoutScheduled_taskInput", {})
export class Dead_messageUpsertWithWhereUniqueWithoutScheduled_taskInput {
  ...
  update!: Dead_messageUpdateWithoutScheduled_taskInput;

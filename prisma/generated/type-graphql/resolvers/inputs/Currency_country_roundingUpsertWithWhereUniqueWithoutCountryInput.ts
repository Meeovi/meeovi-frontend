...
@TypeGraphQL.InputType("Currency_country_roundingUpsertWithWhereUniqueWithoutCountryInput", {})
export class Currency_country_roundingUpsertWithWhereUniqueWithoutCountryInput {
  ...
  update!: Currency_country_roundingUpdateWithoutCountryInput;

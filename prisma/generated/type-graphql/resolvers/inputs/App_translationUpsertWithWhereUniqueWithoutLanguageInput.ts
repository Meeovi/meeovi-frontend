...
@TypeGraphQL.InputType("App_translationUpsertWithWhereUniqueWithoutLanguageInput", {})
export class App_translationUpsertWithWhereUniqueWithoutLanguageInput {
  ...
  update!: App_translationUpdateWithoutLanguageInput;

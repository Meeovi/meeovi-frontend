...
@TypeGraphQL.InputType("Od_scheduler_jobUpsertWithWhereUniqueWithoutOd_scheduler_jobInput", {})
export class Od_scheduler_jobUpsertWithWhereUniqueWithoutOd_scheduler_jobInput {
  ...
  update!: Od_scheduler_jobUpdateWithoutOd_scheduler_jobInput;

  @TypeGraphQL.Field(_type => Od_scheduler_jobCreateWithoutOd_scheduler_jobInput, {
    nullable: false
  })
  create!: Od_scheduler_jobCreateWithoutOd_scheduler_jobInput;
}

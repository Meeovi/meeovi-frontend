...
@TypeGraphQL.InputType("App_script_conditionUpsertWithoutRule_conditionInput", {})
export class App_script_conditionUpsertWithoutRule_conditionInput {
  @TypeGraphQL.Field(_type => App_script_conditionUpdateWithoutRule_conditionInput, {
    nullable: false
  })
  update!: App_script_conditionUpdateWithoutRule_conditionInput;

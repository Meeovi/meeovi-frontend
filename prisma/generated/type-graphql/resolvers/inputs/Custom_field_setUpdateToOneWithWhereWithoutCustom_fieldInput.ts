...
@TypeGraphQL.InputType("Custom_field_setUpdateToOneWithWhereWithoutCustom_fieldInput", {})
export class Custom_field_setUpdateToOneWithWhereWithoutCustom_fieldInput {
  ...
  data!: Custom_field_setUpdateWithoutCustom_fieldInput;
}

...
@TypeGraphQL.InputType("Cms_slot_translationUpdateWithWhereUniqueWithoutCms_slotInput", {})
export class Cms_slot_translationUpdateWithWhereUniqueWithoutCms_slotInput {
  ...
  data!: Cms_slot_translationUpdateWithoutCms_slotInput;
}

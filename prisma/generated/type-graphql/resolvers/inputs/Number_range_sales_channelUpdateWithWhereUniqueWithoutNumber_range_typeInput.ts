...
@TypeGraphQL.InputType("Number_range_sales_channelUpdateWithWhereUniqueWithoutNumber_range_typeInput", {})
export class Number_range_sales_channelUpdateWithWhereUniqueWithoutNumber_range_typeInput {
  ...
  data!: Number_range_sales_channelUpdateWithoutNumber_range_typeInput;
}

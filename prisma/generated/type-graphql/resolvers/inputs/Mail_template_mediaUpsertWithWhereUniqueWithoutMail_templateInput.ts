...
@TypeGraphQL.InputType("Mail_template_mediaUpsertWithWhereUniqueWithoutMail_templateInput", {})
export class Mail_template_mediaUpsertWithWhereUniqueWithoutMail_templateInput {
  ...
  update!: Mail_template_mediaUpdateWithoutMail_templateInput;

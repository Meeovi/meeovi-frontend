...
import { cms_slotIdVersion_idCompoundUniqueInput } from "../inputs/cms_slotIdVersion_idCompoundUniqueInput";

@TypeGraphQL.InputType("Cms_slotWhereUniqueInput", {})
export class Cms_slotWhereUniqueInput {
  @TypeGraphQL.Field(_type => cms_slotIdVersion_idCompoundUniqueInput, {
    nullable: true
  })
  id_version_id?: cms_slotIdVersion_idCompoundUniqueInput | undefined;

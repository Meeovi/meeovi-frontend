...
@TypeGraphQL.InputType("Payment_methodCreateOrConnectWithoutCustomer_customer_last_payment_method_idTopayment_methodInput", {})
export class Payment_methodCreateOrConnectWithoutCustomer_customer_last_payment_method_idTopayment_methodInput {

...
@TypeGraphQL.InputType("Order_line_itemUpdateToOneWithWhereWithoutOrder_line_item_downloadInput", {})
export class Order_line_itemUpdateToOneWithWhereWithoutOrder_line_item_downloadInput {
  ...
  data!: Order_line_itemUpdateWithoutOrder_line_item_downloadInput;
}

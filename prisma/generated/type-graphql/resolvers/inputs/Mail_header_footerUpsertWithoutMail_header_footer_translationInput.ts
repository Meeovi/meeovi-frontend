...
@TypeGraphQL.InputType("Mail_header_footerUpsertWithoutMail_header_footer_translationInput", {})
export class Mail_header_footerUpsertWithoutMail_header_footer_translationInput {
  @TypeGraphQL.Field(_type => Mail_header_footerUpdateWithoutMail_header_footer_translationInput, {
    nullable: false
  })
  update!: Mail_header_footerUpdateWithoutMail_header_footer_translationInput;

  @TypeGraphQL.Field(_type => Mail_header_footerCreateWithoutMail_header_footer_translationInput, {
    nullable: false
  })
  create!: Mail_header_footerCreateWithoutMail_header_footer_translationInput;

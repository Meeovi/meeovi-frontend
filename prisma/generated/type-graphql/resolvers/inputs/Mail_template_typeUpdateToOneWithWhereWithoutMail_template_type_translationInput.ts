...
@TypeGraphQL.InputType("Mail_template_typeUpdateToOneWithWhereWithoutMail_template_type_translationInput", {})
export class Mail_template_typeUpdateToOneWithWhereWithoutMail_template_type_translationInput {
  ...
  data!: Mail_template_typeUpdateWithoutMail_template_type_translationInput;
}

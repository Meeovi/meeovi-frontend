...
@TypeGraphQL.InputType("Product_search_config_fieldUpsertWithWhereUniqueWithoutCustom_fieldInput", {})
export class Product_search_config_fieldUpsertWithWhereUniqueWithoutCustom_fieldInput {
  ...
  update!: Product_search_config_fieldUpdateWithoutCustom_fieldInput;

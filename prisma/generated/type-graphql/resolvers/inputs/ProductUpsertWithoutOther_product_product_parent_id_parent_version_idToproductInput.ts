...
@TypeGraphQL.InputType("ProductUpsertWithoutOther_product_product_parent_id_parent_version_idToproductInput", {})
export class ProductUpsertWithoutOther_product_product_parent_id_parent_version_idToproductInput {
  @TypeGraphQL.Field(_type => ProductUpdateWithoutOther_product_product_parent_id_parent_version_idToproductInput, {
    nullable: false
  })
  update!: ProductUpdateWithoutOther_product_product_parent_id_parent_version_idToproductInput;

  @TypeGraphQL.Field(_type => ProductCreateWithoutOther_product_product_parent_id_parent_version_idToproductInput, {
    nullable: false
  })
  create!: ProductCreateWithoutOther_product_product_parent_id_parent_version_idToproductInput;

...
@TypeGraphQL.InputType("Order_transaction_capture_refund_positionUpdateWithWhereUniqueWithoutOrder_line_itemInput", {})
export class Order_transaction_capture_refund_positionUpdateWithWhereUniqueWithoutOrder_line_itemInput {
  ...
  data!: Order_transaction_capture_refund_positionUpdateWithoutOrder_line_itemInput;
}

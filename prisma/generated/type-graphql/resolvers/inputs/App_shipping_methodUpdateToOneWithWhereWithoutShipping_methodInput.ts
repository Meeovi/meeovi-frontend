...
@TypeGraphQL.InputType("App_shipping_methodUpdateToOneWithWhereWithoutShipping_methodInput", {})
export class App_shipping_methodUpdateToOneWithWhereWithoutShipping_methodInput {
  ...
  data!: App_shipping_methodUpdateWithoutShipping_methodInput;
}

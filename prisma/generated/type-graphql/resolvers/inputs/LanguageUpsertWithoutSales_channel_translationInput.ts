...
@TypeGraphQL.InputType("LanguageUpsertWithoutSales_channel_translationInput", {})
export class LanguageUpsertWithoutSales_channel_translationInput {
  @TypeGraphQL.Field(_type => LanguageUpdateWithoutSales_channel_translationInput, {
    nullable: false
  })
  update!: LanguageUpdateWithoutSales_channel_translationInput;

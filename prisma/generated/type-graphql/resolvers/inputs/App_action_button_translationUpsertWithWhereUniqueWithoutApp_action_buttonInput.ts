...
@TypeGraphQL.InputType("App_action_button_translationUpsertWithWhereUniqueWithoutApp_action_buttonInput", {})
export class App_action_button_translationUpsertWithWhereUniqueWithoutApp_action_buttonInput {
  ...
  update!: App_action_button_translationUpdateWithoutApp_action_buttonInput;

  @TypeGraphQL.Field(_type => App_action_button_translationCreateWithoutApp_action_buttonInput, {
    nullable: false
  })
  create!: App_action_button_translationCreateWithoutApp_action_buttonInput;
}

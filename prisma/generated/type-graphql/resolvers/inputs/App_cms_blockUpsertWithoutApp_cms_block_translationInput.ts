...
@TypeGraphQL.InputType("App_cms_blockUpsertWithoutApp_cms_block_translationInput", {})
export class App_cms_blockUpsertWithoutApp_cms_block_translationInput {
  @TypeGraphQL.Field(_type => App_cms_blockUpdateWithoutApp_cms_block_translationInput, {
    nullable: false
  })
  update!: App_cms_blockUpdateWithoutApp_cms_block_translationInput;

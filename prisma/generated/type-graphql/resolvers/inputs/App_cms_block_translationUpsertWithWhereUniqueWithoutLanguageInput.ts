...
@TypeGraphQL.InputType("App_cms_block_translationUpsertWithWhereUniqueWithoutLanguageInput", {})
export class App_cms_block_translationUpsertWithWhereUniqueWithoutLanguageInput {
  ...
  update!: App_cms_block_translationUpdateWithoutLanguageInput;

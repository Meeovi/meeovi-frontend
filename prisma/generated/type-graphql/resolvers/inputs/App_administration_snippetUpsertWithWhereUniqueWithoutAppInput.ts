...
@TypeGraphQL.InputType("App_administration_snippetUpsertWithWhereUniqueWithoutAppInput", {})
export class App_administration_snippetUpsertWithWhereUniqueWithoutAppInput {
  ...
  update!: App_administration_snippetUpdateWithoutAppInput;

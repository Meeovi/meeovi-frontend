...
@TypeGraphQL.InputType("App_script_condition_translationUpsertWithWhereUniqueWithoutApp_script_conditionInput", {})
export class App_script_condition_translationUpsertWithWhereUniqueWithoutApp_script_conditionInput {
  ...
  update!: App_script_condition_translationUpdateWithoutApp_script_conditionInput;

  @TypeGraphQL.Field(_type => App_script_condition_translationCreateWithoutApp_script_conditionInput, {
    nullable: false
  })
  create!: App_script_condition_translationCreateWithoutApp_script_conditionInput;
}

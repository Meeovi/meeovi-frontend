...
@TypeGraphQL.InputType("Delivery_timeUpsertWithoutDelivery_time_translationInput", {})
export class Delivery_timeUpsertWithoutDelivery_time_translationInput {
  @TypeGraphQL.Field(_type => Delivery_timeUpdateWithoutDelivery_time_translationInput, {
    nullable: false
  })
  update!: Delivery_timeUpdateWithoutDelivery_time_translationInput;

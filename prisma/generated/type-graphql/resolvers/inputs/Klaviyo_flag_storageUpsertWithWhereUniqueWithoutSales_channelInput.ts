...
@TypeGraphQL.InputType("Klaviyo_flag_storageUpsertWithWhereUniqueWithoutSales_channelInput", {})
export class Klaviyo_flag_storageUpsertWithWhereUniqueWithoutSales_channelInput {
  ...
  update!: Klaviyo_flag_storageUpdateWithoutSales_channelInput;

...
@TypeGraphQL.InputType("Mail_template_mediaUpsertWithWhereUniqueWithoutMediaInput", {})
export class Mail_template_mediaUpsertWithWhereUniqueWithoutMediaInput {
  ...
  update!: Mail_template_mediaUpdateWithoutMediaInput;

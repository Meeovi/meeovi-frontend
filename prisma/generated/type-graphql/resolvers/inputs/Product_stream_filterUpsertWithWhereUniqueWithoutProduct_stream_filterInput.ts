...
@TypeGraphQL.InputType("Product_stream_filterUpsertWithWhereUniqueWithoutProduct_stream_filterInput", {})
export class Product_stream_filterUpsertWithWhereUniqueWithoutProduct_stream_filterInput {
  ...
  update!: Product_stream_filterUpdateWithoutProduct_stream_filterInput;

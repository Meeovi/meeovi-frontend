...
@TypeGraphQL.InputType("LanguageUpsertWithoutNumber_range_translationInput", {})
export class LanguageUpsertWithoutNumber_range_translationInput {
  @TypeGraphQL.Field(_type => LanguageUpdateWithoutNumber_range_translationInput, {
    nullable: false
  })
  update!: LanguageUpdateWithoutNumber_range_translationInput;

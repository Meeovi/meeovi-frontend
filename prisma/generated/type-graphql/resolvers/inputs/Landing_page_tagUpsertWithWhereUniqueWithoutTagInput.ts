...
@TypeGraphQL.InputType("Landing_page_tagUpsertWithWhereUniqueWithoutTagInput", {})
export class Landing_page_tagUpsertWithWhereUniqueWithoutTagInput {
  ...
  update!: Landing_page_tagUpdateWithoutTagInput;

...
@TypeGraphQL.InputType("Product_manufacturer_translationUpsertWithWhereUniqueWithoutProduct_manufacturerInput", {})
export class Product_manufacturer_translationUpsertWithWhereUniqueWithoutProduct_manufacturerInput {
  ...
  update!: Product_manufacturer_translationUpdateWithoutProduct_manufacturerInput;

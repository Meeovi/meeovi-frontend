...
@TypeGraphQL.InputType("Cms_slot_translationUpdateWithWhereUniqueWithoutLanguageInput", {})
export class Cms_slot_translationUpdateWithWhereUniqueWithoutLanguageInput {
  ...
  data!: Cms_slot_translationUpdateWithoutLanguageInput;
}

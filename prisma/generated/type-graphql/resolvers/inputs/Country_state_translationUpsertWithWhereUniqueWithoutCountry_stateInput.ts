...
@TypeGraphQL.InputType("Country_state_translationUpsertWithWhereUniqueWithoutCountry_stateInput", {})
export class Country_state_translationUpsertWithWhereUniqueWithoutCountry_stateInput {
  ...
  update!: Country_state_translationUpdateWithoutCountry_stateInput;

  @TypeGraphQL.Field(_type => Country_state_translationCreateWithoutCountry_stateInput, {
    nullable: false
  })
  create!: Country_state_translationCreateWithoutCountry_stateInput;
}

...
@TypeGraphQL.InputType("App_flow_action_translationUpsertWithWhereUniqueWithoutLanguageInput", {})
export class App_flow_action_translationUpsertWithWhereUniqueWithoutLanguageInput {
  ...
  update!: App_flow_action_translationUpdateWithoutLanguageInput;

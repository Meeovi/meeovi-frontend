...
@TypeGraphQL.InputType("Document_base_configUpsertWithWhereUniqueWithoutDocument_typeInput", {})
export class Document_base_configUpsertWithWhereUniqueWithoutDocument_typeInput {
  ...
  update!: Document_base_configUpdateWithoutDocument_typeInput;

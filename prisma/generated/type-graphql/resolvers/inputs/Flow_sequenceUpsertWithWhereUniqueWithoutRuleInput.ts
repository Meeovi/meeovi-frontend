...
@TypeGraphQL.InputType("Flow_sequenceUpsertWithWhereUniqueWithoutRuleInput", {})
export class Flow_sequenceUpsertWithWhereUniqueWithoutRuleInput {
  ...
  update!: Flow_sequenceUpdateWithoutRuleInput;

...
@TypeGraphQL.InputType("Newsletter_recipient_tagUpsertWithWhereUniqueWithoutNewsletter_recipientInput", {})
export class Newsletter_recipient_tagUpsertWithWhereUniqueWithoutNewsletter_recipientInput {
  ...
  update!: Newsletter_recipient_tagUpdateWithoutNewsletter_recipientInput;

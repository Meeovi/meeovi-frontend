...
@TypeGraphQL.InputType("Mail_template_typeUpdateToOneWithWhereWithoutMail_templateInput", {})
export class Mail_template_typeUpdateToOneWithWhereWithoutMail_templateInput {
  ...
  data!: Mail_template_typeUpdateWithoutMail_templateInput;
}

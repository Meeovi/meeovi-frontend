...
import { Product_stream_translationCreateNestedManyWithoutProduct_streamInput } from "../inputs/Product_stream_translationCreateNestedManyWithoutProduct_streamInput";

@TypeGraphQL.InputType("Product_streamCreateWithoutSwag_paypal_pos_sales_channelInput", {})
export class Product_streamCreateWithoutSwag_paypal_pos_sales_channelInput {
  ...
  @TypeGraphQL.Field(_type => Product_stream_translationCreateNestedManyWithoutProduct_streamInput, {
    nullable: true
  })
  product_stream_translation?: Product_stream_translationCreateNestedManyWithoutProduct_streamInput | undefined;
}

...
@TypeGraphQL.InputType("Order_delivery_positionUpsertWithWhereUniqueWithoutOrder_deliveryInput", {})
export class Order_delivery_positionUpsertWithWhereUniqueWithoutOrder_deliveryInput {
  ...
  update!: Order_delivery_positionUpdateWithoutOrder_deliveryInput;

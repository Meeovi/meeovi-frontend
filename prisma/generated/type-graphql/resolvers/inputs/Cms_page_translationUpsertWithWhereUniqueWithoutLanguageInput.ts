...
@TypeGraphQL.InputType("Cms_page_translationUpsertWithWhereUniqueWithoutLanguageInput", {})
export class Cms_page_translationUpsertWithWhereUniqueWithoutLanguageInput {
  ...
  update!: Cms_page_translationUpdateWithoutLanguageInput;

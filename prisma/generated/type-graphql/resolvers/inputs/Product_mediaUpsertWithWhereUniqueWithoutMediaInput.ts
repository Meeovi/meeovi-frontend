...
@TypeGraphQL.InputType("Product_mediaUpsertWithWhereUniqueWithoutMediaInput", {})
export class Product_mediaUpsertWithWhereUniqueWithoutMediaInput {
  ...
  update!: Product_mediaUpdateWithoutMediaInput;

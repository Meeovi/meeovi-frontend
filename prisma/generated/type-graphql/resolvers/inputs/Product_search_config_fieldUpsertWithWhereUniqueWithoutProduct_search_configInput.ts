...
import { Product_search_config_fieldUpdateWithoutProduct_search_configInput } from "../inputs/Product_search_config_fieldUpdateWithoutProduct_search_configInput";
import { Product_search_config_fieldWhereUniqueInput } from "../inputs/Product_search_config_fieldWhereUniqueInput";

@TypeGraphQL.InputType("Product_search_config_fieldUpsertWithWhereUniqueWithoutProduct_search_configInput", {})
export class Product_search_config_fieldUpsertWithWhereUniqueWithoutProduct_search_configInput {
  @TypeGraphQL.Field(_type => Product_search_config_fieldWhereUniqueInput, {
    nullable: false
  })
  where!: Product_search_config_fieldWhereUniqueInput;

  @TypeGraphQL.Field(_type => Product_search_config_fieldUpdateWithoutProduct_search_configInput, {
    nullable: false
  })
  update!: Product_search_config_fieldUpdateWithoutProduct_search_configInput;

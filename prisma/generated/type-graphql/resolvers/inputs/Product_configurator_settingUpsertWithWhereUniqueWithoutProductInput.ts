...
@TypeGraphQL.InputType("Product_configurator_settingUpsertWithWhereUniqueWithoutProductInput", {})
export class Product_configurator_settingUpsertWithWhereUniqueWithoutProductInput {
  ...
  update!: Product_configurator_settingUpdateWithoutProductInput;

...
@TypeGraphQL.InputType("Custom_field_setUpdateToOneWithWhereWithoutProduct_custom_field_setInput", {})
export class Custom_field_setUpdateToOneWithWhereWithoutProduct_custom_field_setInput {
  ...
  data!: Custom_field_setUpdateWithoutProduct_custom_field_setInput;
}

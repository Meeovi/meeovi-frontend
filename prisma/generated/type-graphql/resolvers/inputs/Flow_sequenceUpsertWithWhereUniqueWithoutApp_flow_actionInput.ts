...
@TypeGraphQL.InputType("Flow_sequenceUpsertWithWhereUniqueWithoutApp_flow_actionInput", {})
export class Flow_sequenceUpsertWithWhereUniqueWithoutApp_flow_actionInput {
  ...
  update!: Flow_sequenceUpdateWithoutApp_flow_actionInput;

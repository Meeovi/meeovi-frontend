...
@TypeGraphQL.InputType("ProductUpdateWithoutSwag_paypal_pos_sales_channel_run_logInput", {})
export class ProductUpdateWithoutSwag_paypal_pos_sales_channel_run_logInput {

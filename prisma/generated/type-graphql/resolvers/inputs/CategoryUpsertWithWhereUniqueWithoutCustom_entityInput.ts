...
@TypeGraphQL.InputType("CategoryUpsertWithWhereUniqueWithoutCustom_entityInput", {})
export class CategoryUpsertWithWhereUniqueWithoutCustom_entityInput {
  ...
  update!: CategoryUpdateWithoutCustom_entityInput;

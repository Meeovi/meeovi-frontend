...
@TypeGraphQL.InputType("Landing_page_sales_channelUpsertWithWhereUniqueWithoutSales_channelInput", {})
export class Landing_page_sales_channelUpsertWithWhereUniqueWithoutSales_channelInput {
  ...
  update!: Landing_page_sales_channelUpdateWithoutSales_channelInput;

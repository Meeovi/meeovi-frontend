...
@TypeGraphQL.InputType("Product_manufacturerUpdateWithWhereUniqueWithoutMediaInput", {})
export class Product_manufacturerUpdateWithWhereUniqueWithoutMediaInput {
  ...
  data!: Product_manufacturerUpdateWithoutMediaInput;
}

...
@TypeGraphQL.InputType("Custom_field_set_relationUpdateWithWhereUniqueWithoutCustom_field_setInput", {})
export class Custom_field_set_relationUpdateWithWhereUniqueWithoutCustom_field_setInput {
  ...
  data!: Custom_field_set_relationUpdateWithoutCustom_field_setInput;
}

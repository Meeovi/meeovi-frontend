...
@TypeGraphQL.InputType("CountryUpdateToOneWithWhereWithoutSales_channel_countryInput", {})
export class CountryUpdateToOneWithWhereWithoutSales_channel_countryInput {
  ...
  data!: CountryUpdateWithoutSales_channel_countryInput;
}

...
import { order_line_itemIdVersion_idCompoundUniqueInput } from "../inputs/order_line_itemIdVersion_idCompoundUniqueInput";

@TypeGraphQL.InputType("Order_line_itemWhereUniqueInput", {})
export class Order_line_itemWhereUniqueInput {
  @TypeGraphQL.Field(_type => order_line_itemIdVersion_idCompoundUniqueInput, {
    nullable: true
  })
  id_version_id?: order_line_itemIdVersion_idCompoundUniqueInput | undefined;

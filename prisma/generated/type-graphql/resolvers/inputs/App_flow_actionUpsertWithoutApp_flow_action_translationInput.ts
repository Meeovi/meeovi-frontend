...
@TypeGraphQL.InputType("App_flow_actionUpsertWithoutApp_flow_action_translationInput", {})
export class App_flow_actionUpsertWithoutApp_flow_action_translationInput {
  @TypeGraphQL.Field(_type => App_flow_actionUpdateWithoutApp_flow_action_translationInput, {
    nullable: false
  })
  update!: App_flow_actionUpdateWithoutApp_flow_action_translationInput;

  @TypeGraphQL.Field(_type => App_flow_actionCreateWithoutApp_flow_action_translationInput, {
    nullable: false
  })
  create!: App_flow_actionCreateWithoutApp_flow_action_translationInput;

...
@TypeGraphQL.InputType("Payment_methodUpsertWithoutCustomer_customer_default_payment_method_idTopayment_methodInput", {})
export class Payment_methodUpsertWithoutCustomer_customer_default_payment_method_idTopayment_methodInput {
  @TypeGraphQL.Field(_type => Payment_methodUpdateWithoutCustomer_customer_default_payment_method_idTopayment_methodInput, {
    nullable: false
  })
  update!: Payment_methodUpdateWithoutCustomer_customer_default_payment_method_idTopayment_methodInput;

...
@TypeGraphQL.InputType("Order_transaction_capture_refund_positionUpsertWithWhereUniqueWithoutOrder_transaction_capture_refundInput", {})
export class Order_transaction_capture_refund_positionUpsertWithWhereUniqueWithoutOrder_transaction_capture_refundInput {
  ...
  update!: Order_transaction_capture_refund_positionUpdateWithoutOrder_transaction_capture_refundInput;

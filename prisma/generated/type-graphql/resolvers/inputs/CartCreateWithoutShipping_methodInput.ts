...
import { CountryCreateNestedOneWithoutCartInput } from "../inputs/CountryCreateNestedOneWithoutCartInput";
...
@TypeGraphQL.InputType("CartCreateWithoutShipping_methodInput", {})
export class CartCreateWithoutShipping_methodInput {
  ...
  @TypeGraphQL.Field(_type => CountryCreateNestedOneWithoutCartInput, {
    nullable: false
  })
  country!: CountryCreateNestedOneWithoutCartInput;

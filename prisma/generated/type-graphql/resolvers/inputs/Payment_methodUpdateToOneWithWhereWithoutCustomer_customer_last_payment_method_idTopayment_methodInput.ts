...
@TypeGraphQL.InputType("Payment_methodUpdateToOneWithWhereWithoutCustomer_customer_last_payment_method_idTopayment_methodInput", {})
export class Payment_methodUpdateToOneWithWhereWithoutCustomer_customer_last_payment_method_idTopayment_methodInput {
  ...
  data!: Payment_methodUpdateWithoutCustomer_customer_last_payment_method_idTopayment_methodInput;
}

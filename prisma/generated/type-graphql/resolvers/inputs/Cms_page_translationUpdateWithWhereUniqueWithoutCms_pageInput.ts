...
@TypeGraphQL.InputType("Cms_page_translationUpdateWithWhereUniqueWithoutCms_pageInput", {})
export class Cms_page_translationUpdateWithWhereUniqueWithoutCms_pageInput {
  ...
  data!: Cms_page_translationUpdateWithoutCms_pageInput;
}

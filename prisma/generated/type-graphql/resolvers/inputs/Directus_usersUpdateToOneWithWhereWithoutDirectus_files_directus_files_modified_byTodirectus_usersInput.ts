...
@TypeGraphQL.InputType("Directus_usersUpdateToOneWithWhereWithoutDirectus_files_directus_files_modified_byTodirectus_usersInput", {})
export class Directus_usersUpdateToOneWithWhereWithoutDirectus_files_directus_files_modified_byTodirectus_usersInput {
  ...
  data!: Directus_usersUpdateWithoutDirectus_files_directus_files_modified_byTodirectus_usersInput;
}

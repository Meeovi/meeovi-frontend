...
@TypeGraphQL.InputType("Flow_sequenceUpdateWithWhereUniqueWithoutFlow_sequenceInput", {})
export class Flow_sequenceUpdateWithWhereUniqueWithoutFlow_sequenceInput {
  ...
  data!: Flow_sequenceUpdateWithoutFlow_sequenceInput;
}

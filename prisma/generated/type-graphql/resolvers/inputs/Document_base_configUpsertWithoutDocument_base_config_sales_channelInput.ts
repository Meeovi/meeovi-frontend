...
@TypeGraphQL.InputType("Document_base_configUpsertWithoutDocument_base_config_sales_channelInput", {})
export class Document_base_configUpsertWithoutDocument_base_config_sales_channelInput {
  @TypeGraphQL.Field(_type => Document_base_configUpdateWithoutDocument_base_config_sales_channelInput, {
    nullable: false
  })
  update!: Document_base_configUpdateWithoutDocument_base_config_sales_channelInput;

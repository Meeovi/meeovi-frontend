...
@TypeGraphQL.InputType("Custom_field_setUpdateToOneWithWhereWithoutCustom_field_set_relationInput", {})
export class Custom_field_setUpdateToOneWithWhereWithoutCustom_field_set_relationInput {
  ...
  data!: Custom_field_setUpdateWithoutCustom_field_set_relationInput;
}

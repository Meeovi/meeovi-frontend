...
import { Product_feature_set_translationUpdateWithoutProduct_feature_setInput } from "../inputs/Product_feature_set_translationUpdateWithoutProduct_feature_setInput";
import { Product_feature_set_translationWhereUniqueInput } from "../inputs/Product_feature_set_translationWhereUniqueInput";

@TypeGraphQL.InputType("Product_feature_set_translationUpsertWithWhereUniqueWithoutProduct_feature_setInput", {})
export class Product_feature_set_translationUpsertWithWhereUniqueWithoutProduct_feature_setInput {
  ...
  @TypeGraphQL.Field(_type => Product_feature_set_translationUpdateWithoutProduct_feature_setInput, {
    nullable: false
  })
  update!: Product_feature_set_translationUpdateWithoutProduct_feature_setInput;

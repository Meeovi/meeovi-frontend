...
@TypeGraphQL.InputType("Event_action_sales_channelUpsertWithWhereUniqueWithoutSales_channelInput", {})
export class Event_action_sales_channelUpsertWithWhereUniqueWithoutSales_channelInput {
  ...
  update!: Event_action_sales_channelUpdateWithoutSales_channelInput;

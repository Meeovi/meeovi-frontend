...
@TypeGraphQL.InputType("Order_transactionUpsertWithWhereUniqueWithoutOrderInput", {})
export class Order_transactionUpsertWithWhereUniqueWithoutOrderInput {
  ...
  update!: Order_transactionUpdateWithoutOrderInput;

...
@TypeGraphQL.InputType("ProductUpsertWithWhereUniqueWithoutProduct_feature_setInput", {})
export class ProductUpsertWithWhereUniqueWithoutProduct_feature_setInput {
  ...
  update!: ProductUpdateWithoutProduct_feature_setInput;

...
@TypeGraphQL.InputType("Order_line_itemUpdateWithWhereUniqueWithoutOrder_line_itemInput", {})
export class Order_line_itemUpdateWithWhereUniqueWithoutOrder_line_itemInput {
  ...
  data!: Order_line_itemUpdateWithoutOrder_line_itemInput;
}

...
@TypeGraphQL.InputType("ProductUpsertWithWhereUniqueWithoutProduct_product_canonical_product_idToproductInput", {})
export class ProductUpsertWithWhereUniqueWithoutProduct_product_canonical_product_idToproductInput {
  ...
  update!: ProductUpdateWithoutProduct_product_canonical_product_idToproductInput;

  @TypeGraphQL.Field(_type => ProductCreateWithoutProduct_product_canonical_product_idToproductInput, {
    nullable: false
  })
  create!: ProductCreateWithoutProduct_product_canonical_product_idToproductInput;
}

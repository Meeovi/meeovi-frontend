...
@TypeGraphQL.InputType("Product_stream_translationUpsertWithWhereUniqueWithoutLanguageInput", {})
export class Product_stream_translationUpsertWithWhereUniqueWithoutLanguageInput {
  ...
  update!: Product_stream_translationUpdateWithoutLanguageInput;

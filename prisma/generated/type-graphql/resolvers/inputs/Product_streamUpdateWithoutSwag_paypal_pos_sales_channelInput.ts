...
@TypeGraphQL.InputType("Product_streamUpdateWithoutSwag_paypal_pos_sales_channelInput", {})
export class Product_streamUpdateWithoutSwag_paypal_pos_sales_channelInput {

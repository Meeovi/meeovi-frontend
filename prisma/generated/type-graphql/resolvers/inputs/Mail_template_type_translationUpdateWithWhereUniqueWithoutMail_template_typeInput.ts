...
@TypeGraphQL.InputType("Mail_template_type_translationUpdateWithWhereUniqueWithoutMail_template_typeInput", {})
export class Mail_template_type_translationUpdateWithWhereUniqueWithoutMail_template_typeInput {
  ...
  data!: Mail_template_type_translationUpdateWithoutMail_template_typeInput;
}

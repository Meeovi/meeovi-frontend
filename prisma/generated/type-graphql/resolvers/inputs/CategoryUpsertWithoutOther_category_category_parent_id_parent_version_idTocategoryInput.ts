...
@TypeGraphQL.InputType("CategoryUpsertWithoutOther_category_category_parent_id_parent_version_idTocategoryInput", {})
export class CategoryUpsertWithoutOther_category_category_parent_id_parent_version_idTocategoryInput {
  @TypeGraphQL.Field(_type => CategoryUpdateWithoutOther_category_category_parent_id_parent_version_idTocategoryInput, {
    nullable: false
  })
  update!: CategoryUpdateWithoutOther_category_category_parent_id_parent_version_idTocategoryInput;

  @TypeGraphQL.Field(_type => CategoryCreateWithoutOther_category_category_parent_id_parent_version_idTocategoryInput, {
    nullable: false
  })
  create!: CategoryCreateWithoutOther_category_category_parent_id_parent_version_idTocategoryInput;

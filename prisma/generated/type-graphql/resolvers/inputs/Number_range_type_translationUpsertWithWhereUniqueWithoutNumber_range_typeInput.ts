...
@TypeGraphQL.InputType("Number_range_type_translationUpsertWithWhereUniqueWithoutNumber_range_typeInput", {})
export class Number_range_type_translationUpsertWithWhereUniqueWithoutNumber_range_typeInput {
  ...
  update!: Number_range_type_translationUpdateWithoutNumber_range_typeInput;

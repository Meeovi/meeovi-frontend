...
@TypeGraphQL.InputType("Product_custom_field_setUpdateWithWhereUniqueWithoutCustom_field_setInput", {})
export class Product_custom_field_setUpdateWithWhereUniqueWithoutCustom_field_setInput {
  ...
  data!: Product_custom_field_setUpdateWithoutCustom_field_setInput;
}

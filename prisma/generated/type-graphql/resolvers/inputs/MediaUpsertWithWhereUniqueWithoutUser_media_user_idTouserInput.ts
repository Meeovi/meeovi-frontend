...
@TypeGraphQL.InputType("MediaUpsertWithWhereUniqueWithoutUser_media_user_idTouserInput", {})
export class MediaUpsertWithWhereUniqueWithoutUser_media_user_idTouserInput {
  ...
  update!: MediaUpdateWithoutUser_media_user_idTouserInput;

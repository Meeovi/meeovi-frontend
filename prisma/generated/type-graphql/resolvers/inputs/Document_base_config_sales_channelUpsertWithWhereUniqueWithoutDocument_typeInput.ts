...
@TypeGraphQL.InputType("Document_base_config_sales_channelUpsertWithWhereUniqueWithoutDocument_typeInput", {})
export class Document_base_config_sales_channelUpsertWithWhereUniqueWithoutDocument_typeInput {
  ...
  update!: Document_base_config_sales_channelUpdateWithoutDocument_typeInput;

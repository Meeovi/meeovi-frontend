...
@TypeGraphQL.InputType("Product_cross_selling_assigned_productsUpsertWithWhereUniqueWithoutProduct_cross_sellingInput", {})
export class Product_cross_selling_assigned_productsUpsertWithWhereUniqueWithoutProduct_cross_sellingInput {
  ...
  update!: Product_cross_selling_assigned_productsUpdateWithoutProduct_cross_sellingInput;

...
@TypeGraphQL.InputType("App_flow_actionUpsertWithWhereUniqueWithoutAppInput", {})
export class App_flow_actionUpsertWithWhereUniqueWithoutAppInput {
  ...
  update!: App_flow_actionUpdateWithoutAppInput;

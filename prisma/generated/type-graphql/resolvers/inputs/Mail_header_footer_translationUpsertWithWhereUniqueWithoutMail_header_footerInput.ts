...
@TypeGraphQL.InputType("Mail_header_footer_translationUpsertWithWhereUniqueWithoutMail_header_footerInput", {})
export class Mail_header_footer_translationUpsertWithWhereUniqueWithoutMail_header_footerInput {
  ...
  update!: Mail_header_footer_translationUpdateWithoutMail_header_footerInput;

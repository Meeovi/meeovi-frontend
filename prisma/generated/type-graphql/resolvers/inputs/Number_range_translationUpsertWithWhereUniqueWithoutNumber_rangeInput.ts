...
@TypeGraphQL.InputType("Number_range_translationUpsertWithWhereUniqueWithoutNumber_rangeInput", {})
export class Number_range_translationUpsertWithWhereUniqueWithoutNumber_rangeInput {
  ...
  update!: Number_range_translationUpdateWithoutNumber_rangeInput;

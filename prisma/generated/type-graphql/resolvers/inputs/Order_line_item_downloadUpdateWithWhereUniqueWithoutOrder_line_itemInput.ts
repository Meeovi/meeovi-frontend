...
@TypeGraphQL.InputType("Order_line_item_downloadUpdateWithWhereUniqueWithoutOrder_line_itemInput", {})
export class Order_line_item_downloadUpdateWithWhereUniqueWithoutOrder_line_itemInput {
  ...
  data!: Order_line_item_downloadUpdateWithoutOrder_line_itemInput;
}

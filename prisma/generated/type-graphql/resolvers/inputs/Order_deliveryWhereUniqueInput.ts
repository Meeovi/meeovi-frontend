...
import { order_deliveryIdVersion_idCompoundUniqueInput } from "../inputs/order_deliveryIdVersion_idCompoundUniqueInput";

@TypeGraphQL.InputType("Order_deliveryWhereUniqueInput", {})
export class Order_deliveryWhereUniqueInput {
  @TypeGraphQL.Field(_type => order_deliveryIdVersion_idCompoundUniqueInput, {
    nullable: true
  })
  id_version_id?: order_deliveryIdVersion_idCompoundUniqueInput | undefined;

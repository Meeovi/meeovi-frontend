...
@TypeGraphQL.InputType("Promotion_cart_ruleUpsertWithWhereUniqueWithoutPromotionInput", {})
export class Promotion_cart_ruleUpsertWithWhereUniqueWithoutPromotionInput {
  ...
  update!: Promotion_cart_ruleUpdateWithoutPromotionInput;

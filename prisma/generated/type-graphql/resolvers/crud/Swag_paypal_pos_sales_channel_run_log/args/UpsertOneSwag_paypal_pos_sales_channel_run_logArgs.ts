...
export class UpsertOneSwag_paypal_pos_sales_channel_run_logArgs {
  ...
  create!: Swag_paypal_pos_sales_channel_run_logCreateInput;

  @TypeGraphQL.Field(_type => Swag_paypal_pos_sales_channel_run_logUpdateInput, {
    nullable: false
  })
  update!: Swag_paypal_pos_sales_channel_run_logUpdateInput;
}

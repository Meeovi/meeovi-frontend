...
export class FindFirstDocument_type_translationOrThrowArgs {
  ...
  distinct?: Array<"document_type_id" | "language_id" | "name" | "custom_fields" | "created_at" | "updated_at"> | undefined;
}

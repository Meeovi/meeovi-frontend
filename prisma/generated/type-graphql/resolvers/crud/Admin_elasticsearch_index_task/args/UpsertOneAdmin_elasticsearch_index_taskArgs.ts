...
export class UpsertOneAdmin_elasticsearch_index_taskArgs {
  ...
  create!: Admin_elasticsearch_index_taskCreateInput;

  @TypeGraphQL.Field(_type => Admin_elasticsearch_index_taskUpdateInput, {
    nullable: false
  })
  update!: Admin_elasticsearch_index_taskUpdateInput;
}

                    ...
                    <div class="card col-12 col-md-6 col-lg-4">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                ...
                                <h5 class="card-text mbr-fonts-style display-4">June 7, 2023</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card col-12 col-md-6 col-lg-4">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                ...
                                <h5 class="card-text mbr-fonts-style display-4">113-1373363-9863454</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card col-12 col-md-6 col-lg-4">
                    ...
                    <div class="card col-12 col-md-6">
                        <div class="card-wrapper">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">Amazon Hub Locker+ (North Las Vegas)
                                    <br>1200 E. Alexander Rd
                                    <br>North Las Vegas, NV 89030
                                    <br>United States</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card col-12 col-md-6">
                        <div class="card-wrapper">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">Item(s) Subtotal: $17.08
                                    <br>Shipping &amp; Handling: $0.00
                                    <br>Total before tax: $17.08
                                    <br>Estimated tax to be collected: $1.43
                                    <br>Grand Total: $18.51</p>
                            </div>
                        </div>
                    </div>
                    <div class="card col-12 col-md-6">
                        <div class="card-wrapper">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">Items shipped: June 7, 2023 - Visa ending
                                    in 7998: $18.51
                                    <br>
                                    <br>Total: $18.51</p>
                            </div>

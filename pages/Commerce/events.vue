<template>
    <div>
        <section data-bs-version="5.1" class="shop2 marketm4_shop2 cid-twaWgxQFRv" id="shop2-4k"
            data-sortbtn="btn-primary">

            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div
                        class="mb-md-0 col-xl-5 col-lg-4 col-md-2 col-sm-6 d-md-flex align-items-stretch image justify-content-end">
                        <img src="../../assets/images/big-height.jpg" alt="" data-target="#mbrCarousel"

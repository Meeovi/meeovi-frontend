<template>
    <div>
        <section data-bs-version="5.1" class="features15 popup-btn-cards cid-txYdpRZBAq mbr-parallax-background" id="features15-59">
...
<section data-bs-version="5.1" class="features5 popup-btn-cards cid-txYeO4T8w7" id="features5-5c">
            ...
            <div class="card-wrapper ">
                <div class="card-img">
                    ...
                    <div class="mbr-section-btn text-center">
                        <a href="#" class="btn btn-white display-4">
                            View All
                        </a>
                    </div>
...
<section data-bs-version="5.1" class="features16 cid-txYguGL3oY" id="features16-5d">
        ...
        <div class="col-md-6 text-element">
            <div class="text-content">
                <h2 class="mbr-title pt-2 mbr-fonts-style align-left mbr-white display-2">
                    Fabric Patterns and themes</h2>
                
                <div class="mbr-section-text">
                    <p class="mbr-text pt-3 mbr-light mbr-fonts-style align-left mbr-white display-7">
                        From Solid Fabrics, Printed fabrics, floral fabrics, to baby-themed fabrics.</p>
                </div>
                <div class="mbr-section-btn pt-3 align-left"><a class="btn btn-md btn-success display-4" href="#">VIEW PATTERNS and THEMES</a></div>
            </div>
        </div>
    </div>
</div>          
...
<section data-bs-version="5.1" class="mbr-section info1 cid-txYdAORAxw mbr-parallax-background" id="info1-5a">
...
<div class="container-fluid">
    <div class="media-container-row">
        <div class="title col-12 col-md-8">
            <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2">Shop top fabric brands</h2>
...
<section data-bs-version="5.1" class="mbr-section features18 cid-txYdCuSkCG" id="features18-5b">
...
<section data-bs-version="5.1" class="mbr-section features20 cid-txYd9kCzPY" id="features20-58">

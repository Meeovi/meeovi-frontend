<template>
    <div>
        <section data-bs-version="5.1" class="header4 cid-twaJzJWR7z mbr-fullscreen mbr-parallax-background" id="header4-4b" data-sortbtn="btn-primary">
    ...
    <div class="row  align-items-center">
        <div class="col-md-12">
            ...
            <p class="mbr-text align-left py-2 mbr-fonts-style display-5">
                Welcome to Meeovi Yardsale</p>
            <div class="mbr-media show-modal align-center py-2">
                <div class="btn-play" data-modal=".modalWindow">
                   <span class="play"></span> 
                </div>
                <div class="mbr-section-btn align-left"><a class="btn btn-lg btn-primary display-4" href="/search/results">Let's Start</a></div>
            </div>
...
<section data-bs-version="5.1" class="mbr-section features20 cid-txSS3F0p67" id="features20-53" data-sortbtn="btn-primary">
...
<section data-bs-version="5.1" class="features1 cid-twaJGzct6V" id="features1-4c" data-sortbtn="btn-primary">
            ...
            <div class="text-content">
                ...
                <div class="mbr-section-text">
                    <p class="mbr-text pt-3 mbr-light mbr-fonts-style align-center mbr-white display-7">
                        Meeovi Yardsale is a store within Meeovi that uses your Meeovi account as a way to purchase with the same system as any other part of Meeovi.</p>
                </div>
                <div class="mbr-section-btn pt-3 align-center"><a class="btn btn-md btn-white display-4" href="/categories/">Shop Now</a></div>
            </div>
        </div>
    </div>
</div>          
...
<section data-bs-version="5.1" class="header8 cid-txST4cTqu4 mbr-fullscreen" id="header8-54" data-sortbtn="btn-primary">
...
<div class="animated-text-background display-7" style="color: rgb(239, 239, 239); opacity: 0.2; font-size: 10rem;">
    <span class="animated-element" data-word="Meeovi Yardsale" data-speed="60">
    </span>
</div>
<div class="container">
    <div class="row align-items-center">
        ...
        <div class="mbr-white col-md-6">
            ...
            <p class="mbr-text pb-3 mbr-fonts-style mbr-white align-left display-5">
                Sell returned goods at an amazing price, buy refurbish products, make bids, and open your own store.</p>
            <div class="mbr-section-btn"><a class="btn btn-lg btn-white display-4" type="submit" href="/auth/signup">Signup</a></div>
        </div>
    </div>
</div>

<template>
    <div id="thank-you">
        <SfCallToAction v-e2e="'thank-you-banner'" class="banner" title="Thank you for your order!" :image="{
        ...
        <section class="section">
            <div class="order">
                <SfHeading title="Your Purchase" class="order__heading heading sf-heading--left" :level="3" />
                <p class="order__paragraph paragraph">
                    {{ $t('Successful placed order') }}
                </p>
                <div class="order__contact">
                    <SfHeading :level="6" class="heading sf-heading--left sf-heading--no-underline"
                        title="Primary contacts for any questions"></SfHeading>
                    <div class="contact">
                ...
                <SfButton class="order__notifications-button button-size">{{ $t('Allow order notifications') }}
                </SfButton>
            </div>
            <div class="additional-info">
                <div>
                    <SfHeading title="Your Account" class="heading sf-heading--left" :level="3" />
                    <p class="paragraph">
                        {{ $t('Info after order') }}
                    </p>
                </div>
                <div>
                    <SfHeading title="What can we improve" class="heading sf-heading--left" :level="3" />
                    <p class="paragraph">
                        {{ $t('Feedback') }}
                    </p>
        ...
        <SfButton class="back-button color-secondary button-size">{{ $t('Go back to shop') }}</SfButton>
    </div>
</template>
...
<style lang="scss" scoped>
    ...
    .order {
        ...
        @include for-desktop {
            width: 100%;
            padding: var(--spacer-xl) var(--spacer-xl) var(--spacer-2xl) var(--spacer-2xl);
        }

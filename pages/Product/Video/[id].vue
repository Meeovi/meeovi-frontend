<template>
    <div>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-7 video-block">
                        <div class="video-wrapper"><iframe class="mbr-embedded-video"
                                src="https://www.youtube.com/embed/VA8PzkQa8d8?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0"
                    ...
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            ...
                            <p class="mbr-text mbr-fonts-style display-7">By:<br>Published On:<br><br>It is a long
        ...
        <section class="content2 cid-sC3Si11MPr" id="content2-2w">
            ...
            <div class="container">
                <div class="mbr-section-head">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Across Meeovi
                            Theater</strong></h4>
                    ...
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            ...
                            <div class="mbr-section-btn item-footer mt-2"><a href=""
                                    class="btn item-btn btn-danger display-7" target="_blank">Read More
                                    &gt;</a></div>
                        </div>
                    </div>
                    <div class="item features-image сol-12 col-md-6 col-lg-4">

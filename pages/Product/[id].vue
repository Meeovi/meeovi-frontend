<template>
    <div>
        <section class="features6 cid-so82XQClCQ" id="features7-1l">
            <!---->
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6">
                            <div class="image-wrapper">
                                <img src="../../assetsimages/product2.jpg" alt="Mobirise">
                            </div>
                        </div>
                        <div class="col-12 col-lg">
                            <div class="text-box">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">If you're wondering how to build a
                                    website, Mobirise can be the answer. Start creating your website with pre-made
                                    blocks and place your own content. Select the theme that suits you. Each theme
                                    contains a set of unique blocks.</p>
                                <div class="cost">
        ...
        <section class="features14 cid-so83chVBVL" id="features15-1m">
                ...
                <div class="row justify-content-center">
                    <div class="card col-12 col-md-6 col-lg-4">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                <h4 class="card-title mbr-fonts-style mb-2 display-7"><strong>Optimized Images</strong>
                                </h4>
                    ...
                    <div class="card col-12 col-md-6 col-lg-4">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                <h4 class="card-title mbr-fonts-style mb-2 display-7"><strong>Style Changer</strong>
                                </h4>
        ...
        <section class="content4 cid-so8ctdwhwn" id="content4-1t">
        ...
        <section class="features10 cid-so85VzKZVS" id="features11-1o">
            <!---->
            ...
            <div class="container">
                <div class="title">
                    <h3 class="mbr-section-title mbr-fonts-style mb-4 display-5">
                        <strong>Goes good with</strong></h3>
                    ...
                    <div class="card-wrapper">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-3">
                                <div class="image-wrapper">
                                    <img src="../../assetsimages/product1.jpg" alt="Mobirise" title="">
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-wrapper">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-3">
                                <div class="image-wrapper">
                                    <img src="../../assetsimages/product2.jpg" alt="Mobirise" title="">
                                </div>
                            </div>
                            <div class="col-12 col-md">
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="top-line">
                                                <h4 class="card-title mbr-fonts-style display-5"><strong>Mug</strong>
                                                </h4>
                                                <p class="cost mbr-fonts-style display-5">
                                                    $49</p>
                                            </div>
        ...
        <section class="image1 cid-so86k7f2Ri" id="image1-1r">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6">
                        <div class="image-wrapper">
                            <img src="../../assetsimages/4.jpg" alt="Mobirise">
                    ...
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            <h3 class="mbr-section-title mbr-fonts-style mb-3 display-7"><strong>Package
                                    Dimensions:</strong><br><strong>Item
                                    Weight:</strong><br><strong>ASIN:</strong><br><strong>Best Selling
                                    Rank:</strong><br><strong>Date First Available:</strong></h3>
                            <p class="mbr-text mbr-fonts-style display-7">
                                ...
                                description below your image, or on the side. If you want to hide some of the text
        ...
        <section class="features3 cid-so865aQjmw" id="features3-1p">


            <div class="container">
                <div class="mbr-section-head">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-5">
                        <strong>Our own brands</strong></h4>
        ...
        <section class="features3 cid-so869gEgN3" id="features3-1q">


            <div class="container">
                <div class="mbr-section-head">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-5">
                        <strong>Related Products</strong></h4>
        ...
        <section class="content2 cid-so86Lv9bRH" id="content2-1s">


            <div class="container">
                <div class="mbr-section-head">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-5"><strong>Posts about this
                            Category</strong></h4>
                    <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-7">These blog posts
                        are from users like yourself about products you like</h5>
                </div>
                <div class="row mt-4">
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="../../assetsimages/product5.jpg" alt="" title="">
                            </div>
                            <div class="item-content">
                    ...
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="../../assetsimages/product4.jpg" alt="" title="">
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-5"><a href="#top"
                    ...
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="../../assetsimages/product3.jpg" alt="" title="">
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-5"><a href="#top"

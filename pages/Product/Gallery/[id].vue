<template>
    <div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="mbr-white col-md-6">
                        <h4 class="mbr-section-subtitle mbr-fonts-style align-left pb-2 display-5"><strong>LOREM
                                ISPUM</strong> DOLOR SIT AMET CONSECTETUR</h4>
                        <h1 class="mbr-section-title mbr-white mbr-bold mbr-fonts-style align-left display-1">New sports
                            collection already on sale</h1>

                        <div class="mbr-section-btn pt-3"><a class="btn btn-lg btn-white display-4" type="submit"
                                href="gallery.html#features7-2t">Start Shopping</a></div>
                    </div>
                </div>
            </div>
        ...
        <section data-bs-version="5.1" class="features6 cid-sBY4dxzofj" id="features7-2t">
            <!---->
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg">
                            <div class="text-box">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">Lorem Ipsum is simply dummy text of the
        ...
        <section data-bs-version="5.1" class="mbr-section features20 cid-tyDnJA9F7Q" id="features20-5p">

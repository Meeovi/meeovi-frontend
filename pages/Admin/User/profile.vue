<template>
    <div>
        <section data-bs-version="5.1" class="team2 cid-sqmMeKl3Zp" id="team2-6">
                    ...
                    <div class="col-12 col-md">
                        <div class="card-box">
                            ...
                            <h6 class="mbr-fonts-style mb-3 display-4">
                                <strong>Programmer</strong><br><strong>Followers</strong><br><strong>Following</strong></h6>
...
<section data-bs-version="5.1" class="tabs content18 cid-sqmOcX5Eur" id="tabs1-8">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-12 col-md-12">
                <ul class="nav nav-tabs mb-4" role="tablist">
                    <li class="nav-item first mbr-fonts-style"><a class="nav-link mbr-fonts-style show active display-7" role="tab" data-toggle="tab" data-bs-toggle="tab" href="#tabs1-8_tab0" aria-selected="true"><strong>My Photos</strong></a></li>
                    <li class="nav-item"><a class="nav-link mbr-fonts-style active display-7" role="tab" data-toggle="tab" data-bs-toggle="tab" href="#tabs1-8_tab1" aria-selected="true"><strong>My Faves</strong></a></li>
                    <li class="nav-item"><a class="nav-link mbr-fonts-style active display-7" role="tab" data-toggle="tab" data-bs-toggle="tab" href="#tabs1-8_tab2" aria-selected="true"><strong>My Groups</strong></a></li>
                    <li class="nav-item"><a class="nav-link mbr-fonts-style active display-7" role="tab" data-toggle="tab" data-bs-toggle="tab" href="#tabs1-8_tab3" aria-selected="true"><strong>Albums</strong></a></li>
...
<section data-bs-version="5.1" class="features3 cid-sqmO18UW4s" id="features3-7">

        ...
        <div class="row justify-content-center align-items-start">
            ...
            <div class="card px-3 py-4 col-md-4">
                <div class="card-wrapper flip-card">
                    ...
                    <div class="card-box">
                        <h3 class="mbr-title mbr-fonts-style mbr-black align-center display-2">Gift Registry</h3>
            ...
            <div class="card px-3 py-4 col-md-4">
                <div class="card-wrapper flip-card">
                    ...
                    <div class="card-box">
                        <h3 class="mbr-title mbr-fonts-style mbr-black align-center display-2">Baby Registry</h3>
                        <p class="mbr-card-text mbr-fonts-style align-center display-7">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                        </p>
                        <div class="mbr-section-btn align-center pt-3">
            ...
            <div class="card px-3 py-4 col-md-4">
                <div class="card-wrapper flip-card">
                    ...
                    <div class="card-box">
                        <h3 class="mbr-title mbr-fonts-style mbr-black align-center display-2">Wish Lists</h3>
                        <p class="mbr-card-text mbr-fonts-style align-center display-7">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                        </p>
                        <div class="mbr-section-btn align-center pt-3">

<template>
    <div>
        ...
        <section data-bs-version="5.1" class="features6 popup-btn-cards cid-txNjbpSVpF" id="features6-4m">
            ...
            <div class="container">
                <h2 class="align-center mbr-fonts-style mbr-section-title display-2">Theater Collections</h2>
                            ...
                            <div class="wrapper">
                                ...
                                <div class="collapsed-content">
                                    ...
                                    <div class="mbr-section-btn"><a class="btn btn-md btn-info display-4"
                                            href="/categories/Movies">Movies</a></div>
                                </div>
                            </div>
                        </div>
                    </div>

<template>
    <div>
        ...
        <section data-bs-version="5.1" class="features6 popup-btn-cards cid-txNjbpSVpF" id="features6-4m">
            ...
            <div class="container">
                <h2 class="align-center mbr-fonts-style mbr-section-title display-2">Books Collections</h2>
                            ...
                            <div class="wrapper">
                                ...
                                <div class="collapsed-content">
                                    ...
                                    <div class="mbr-section-btn"><a class="btn btn-md btn-info display-4"
                                            href="/categories/audiobooks">Audiobooks</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="image-element card-wrapper">
                            ...
                            <div class="wrapper">
                                ...
                                <div class="collapsed-content">
                                    ...
                                    <div class="mbr-section-btn"><a class="btn btn-md btn-info display-4"
                                            href="/categories/comics">Comics</a></div>
                                </div>
                            </div>
                        </div>
                    </div>

<template>
    <div>
        <gamebar />
        <section data-bs-version="5.1" class="features15 popup-btn-cards cid-txNj8ml5nb mbr-parallax-background"
            id="features15-4l">
        ...
        <section data-bs-version="5.1" class="features6 popup-btn-cards cid-txNjbpSVpF" id="features6-4m">




            <div class="container">
                <h2 class="align-center mbr-fonts-style mbr-section-title display-2">Game Sections</h2>
                            ...
                            <div class="wrapper">
                                ...
                                <div class="collapsed-content">
                                    <p class="mbr-text mbr-white mbr-fonts-style display-7">
                                        ...
                                        corrupti labore, aliquid est, pariatur natus.
                                    </p>
                                    <div class="mbr-section-btn"><a class="btn btn-md btn-info display-4"
                                            href="/categories/walkthroughs">Walkthroughs</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="image-element card-wrapper">
                            ...
                            <div class="wrapper">
                                ...
                                <div class="collapsed-content">
                                    ...
                                    <div class="mbr-section-btn"><a class="btn btn-md btn-info display-4"
                                            href="/categories/gamestreaming">Streaming</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section data-bs-version="5.1" class="mbr-section features20 cid-txNjkLmoOJ" id="features20-4o">
        ...
        <section data-bs-version="5.1" class="teams1 cid-twaGraj1h8" id="teams1-41">
            ...
            <div class="container">
                ...
                <h3 class="mbr-section-subtitle mbr-fonts-style align-left pt-2 display-5"><em>Show them support by
                        following them</em></h3>
...
<script>
    import gamebar from '../../components/Menus/gamebar.vue'

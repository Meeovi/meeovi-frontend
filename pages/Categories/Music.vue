...
<div class="container">
    <h2 class="align-center mbr-fonts-style mbr-section-title display-2">Music Collections</h2>
            ...
            <div class="image-element card-wrapper">
                ...
                <div class="wrapper">
                    ...
                    <div class="collapsed-content">
                        ...
                        <div class="mbr-section-btn"><a class="btn btn-md btn-info display-4" href="/categories/charts">Charts</a></div>
                    </div>
               </div>
           </div>
        </div>
            ...
            <div class="image-element card-wrapper">
                ...
                <div class="wrapper">
                    ...
                    <div class="collapsed-content">
                        ...
                        <div class="mbr-section-btn"><a class="btn btn-md btn-info display-4" href="/categories/radio">Radio</a></div>
                    </div>
                </div>
            </div>
        </div>

<template>
    <div>
        <section class="info3 cid-skfr3z0VjG" id="info3-10">
            ...
            <div class="card-wrapper">
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style align-center mb-4 display-1">
                        <strong>Deals</strong></h4>
                    <p class="mbr-text mbr-fonts-style mb-4 display-7">Deals under $25 are found here weekly&nbsp;<br></p>
...
<section class="features3 cid-skfr1HeAMU" id="features3-z">

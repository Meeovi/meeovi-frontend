            ...
            <v-row class="orderRow">
              <v-col>
                <v-list lines="two" class="orderToolbar">
                  <v-list-item-title>Cancelled Ordered On</v-list-item-title>
                  <v-list-item-subtitle>{{ orders?.quantity_canceled }}</v-list-item-subtitle>
                </v-list>
              </v-col>
              ...
              <v-col>
                <v-list lines="two" class="orderToolbar">
                  ...
                  <v-list-item-subtitle>{{orders?.shipping_address?.street}} {{orders?.shipping_address?.city}} {{orders?.shipping_address?.postcode}} {{orders?.shipping_address?.country_code}} {{orders?.shipping_address?.region}}</v-list-item-subtitle>
                </v-list>
              </v-col>

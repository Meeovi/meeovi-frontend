<template>
    <div class="contentPage">
        <profilebar />
        <v-toolbar color="transparent" density="compact" title="Payments">
            <addPayment />
        </v-toolbar>
        <v-table fixed-header>
            ...
            <tbody>
                <tr v-for="(address, index) in data?.customer?.addresses" :key="index">
                    ...
                    <td><v-btn icon="fas fa-home" title="View" :href="`/Account/User/addAccount/add-payment/${address?.id}`"></v-btn></td>
                </tr>
            </tbody>
        </v-table>
    </div>

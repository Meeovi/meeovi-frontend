<template>
    <div>
        <section data-bs-version="5.1" class="header1 cid-tuFtoSsKHW mbr-fullscreen mbr-parallax-background" id="header1-3u">
...
<div class="container">
    <div class="row">
        <div class="col-12 col-lg-5">
            <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Meeovi Crafts</strong></h1>
            
            <p class="mbr-text mbr-fonts-style display-7">
                Meeovi Crafts is Meeovi's one stop shop for things you won't find anywhere else. Everything is unique and made by the community.&nbsp;</p>
            <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="/sell/">Create A Shop</a></div>
        </div>
    </div>
</div>
</section>

<section data-bs-version="5.1" class="features13 cid-txSyTsNEct mbr-parallax-background" id="features13-4z">
...
<section data-bs-version="5.1" class="mbr-section features13 cid-txSzpOtTxk mbr-parallax-background" id="features13-51">
    ...
    <div class="row">
        <div class="col-12 text-row col-md-6">
            <h2 class="align-center pb-3 mbr-fonts-style display-2">
                Garden Furniture and Decor</h2>
            <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-7">
                Editor's Pick</h3>
            <div class="mbr-section-btn title-btn align-center"><a class="btn btn-black-outline display-4" href="#">See more</a></div>
        </div>
...
<section data-bs-version="5.1" class="features12 cid-txSzgrLfCD" id="features12-50">
...
<section data-bs-version="5.1" class="features11 cid-txSDhIjFK3" id="features11-52">
              ...
              <div class="table-wrap">
                  ...
                  <div class="table-heading">
                      <h1 class="table-pricing mbr-fonts-style display-5">
                          A community doing good</h1>
                  </div>
                  <hr>
                  <h3 class="mbr-fonts-style mbr-section-subtitle align-left mbr-light pt-3 display-7">Etsy is a global online marketplace, where people come together to make, sell, buy and collect unique items. We’re also a community pushing for positive change for small businesses, people, and the planet. Here are some of the ways we’re making a positive impact, together.
<div><br></div></h3>
          ...
          <div class="col-xl-3 col-md-6 col-10">
              <div class="table-wrap">
                  ...
                  <div class="table-heading">
                      <h1 class="table-pricing mbr-fonts-style display-5">Support independent creators</h1>
                  </div>
                  <hr>
                  <h3 class="mbr-fonts-style mbr-section-subtitle align-left mbr-light pt-3 display-7">There’s no Etsy warehouse – just millions of people selling the things they love. We make the whole process easy, helping you connect directly with makers to find something extraordinary.
<div>
</div><div><br></div></h3>
          ...
          <div class="col-xl-3 col-md-6 col-10">
              <div class="table-wrap">
                  ...
                  <div class="table-heading">
                      <h1 class="table-pricing mbr-fonts-style display-5">Peace of mind</h1>
                  </div>
                  <hr>
                  <h3 class="mbr-fonts-style mbr-section-subtitle align-left mbr-light pt-3 display-7">Your privacy is the highest priority of our dedicated team. And if you ever need assistance, we are always ready to step in for support.
<div>
</div><div><br></div></h3>

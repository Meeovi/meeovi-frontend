...
import { ProductListQuery } from '~/graphql/queries-mutations_subscriptions/types/ProductList.query';
...
/** @namespace ~/graphql/queries-mutations_subscriptions/types/ProductCompare/Query */
